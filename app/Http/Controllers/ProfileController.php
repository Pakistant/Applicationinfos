...
class ProfileController extends Controller
{
    ...
    public function update(ProfileUpdateRequest $request): RedirectResponse
    {
       ...
       if($request->hasFile('image')){ 
        ...
        $file_name=date('YmdHs').'.'.$ext; $request->file('image')->move(public_path('back_auth/assets/Profile'),$file_name);
        ...
        return Redirect::route('profile.edit')->with('status', 'profile modifier avec succes');
    }
