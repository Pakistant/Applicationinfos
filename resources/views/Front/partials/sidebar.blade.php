...
@if($global_tags->isNotEmpty())<div class="sidebar-panel"><p class="eyebrow">Explorer</p><h2 class="section-heading">Thématiques</h2><div class="tag-cloud">@foreach($global_tags as $tag)<a href="#">#{{ $tag->name }}</a>@endforeach</div></div>@endif
