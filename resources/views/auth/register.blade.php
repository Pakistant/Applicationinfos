...
<h1 class="mb-3">S'inscrire</h1>
							<form action="{{route('register')}}" method="POST">
								...
								<div class="form-group">
									<input class="form-control" type="text" name="name"  value="{{old('name')}}" placeholder="Nom"> 	</div>
									@error('name')
							...
							<div class="text-center dont-have">Vous avez deja un compte? <a href="{{('login')}}">Se connecter</a> </div>
